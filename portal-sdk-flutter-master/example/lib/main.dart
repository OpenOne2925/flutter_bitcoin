            ...
            children: <Widget>[
              ...
              TextButton(
                onPressed: () async {
                  ...
                  setState(() => _status = 'ext: ${desc.external_descriptor}, int: ${desc.internal_descriptor}');
                },
                child: Text('Request Descriptors'),
              ),
              TextButton(
                onPressed: () async {
                  await _sdkFlutterPlugin.generateMnemonic(GenerateMnemonicWords.Words12, "testnet", null);
